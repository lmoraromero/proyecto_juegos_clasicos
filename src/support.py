...
def juego1():
    ...
    print('''¡Las normas del juego son simples!
        ...
        2. ¡Un, dos, tres! ¡Piedra, Papel o Tijera!: Tendrás que elegir una de las dos opciones. La máquina hace una elección aleatoria y se muestran a la vez. 
...
def juego2():
    ...
    if points == 10:
        ...
        print(f'Has conseguido {points}. ¡Vuelve a intentarlo!')
    elif points > 0 and points < 4:
        print(f'Has conseguido {points}. ¡Vuelve a intentarlo!')
    elif points >= 4 and points <= 6:
        print(f'Has conseguido {points}. No está mal, aún puedes mejorar ;)')
    elif points >= 7 and points <= 9:
        print(f'Has conseguido {points}. ¡Está muy bien!')